...
export default class KpiCard extends LightningElement {
  ...
  /**
   * Optional value text color. When set to 'green', the value renders in
   * SLDS green-60. Any other / empty value leaves the default navy color.
   */
  @api valueColor = "";
  ...
  /** Adds the `value-green` modifier only when `valueColor === 'green'`. */
  get valueClass() {
    return this.valueColor === "green" ? "ir-kpi-card__value value-green" : "ir-kpi-card__value";
  }
