...
import { COLUMNS, WIRE_ID_QUERY, getRecords, totalMatched, toRows } from "c/wireMatchingShared";

/**
 * OfferingWireTotalMatched - the "Total Matched" wire matching category table.
 * Data comes from c/wireMatchingShared (in-memory seed, no server calls).
 */
export default class OfferingWireTotalMatched extends NavigationMixin(LightningElement) {
  ...
  get _filtered() {
    return totalMatched(getRecords(this.wireUrl));
  }
