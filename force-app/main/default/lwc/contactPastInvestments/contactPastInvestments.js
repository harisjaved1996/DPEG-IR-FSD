...
// Dummy data for the Past Investments tab (two rows, different values from Active).
const DATA = [
  {
    id: "1",
    ...
    contributed: "$300,000.00",
    distributed: "$380,000.00"
  },
  {
    id: "2",
    ...
    entity: TARGET_INVESTING_ENTITY_NAME,
    ownership: "2.00%",
    committed: "$600,000.00",
    contributed: "$600,000.00",
    distributed: "$720,000.00"
  }
];

export default class ContactPastInvestments extends NavigationMixin(LightningElement) {
  columns = COLUMNS;
